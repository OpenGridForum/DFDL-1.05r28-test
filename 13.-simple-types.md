...
\[38\] Reference for this CA Realia 0x20 overpunch for negative sign is the article: "EBCDIC to ASCII Conversion of Signed Fields" [\[CARealia\]](29.-references.md) where it says:   
...
The pattern described below is derived from the ICU DecimalFormat class described here: [\[ICUDecimal\]](29.-references.md)
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>The IANA time zone format (also known as the Olson time zone format) may
          also be used. (e.g., America/New_York)) See <a href="29.-references.md">[IANATimeZone]</a>.</p>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>Ignored if dfdl:calendarTimeZone is specified in UTC format, or if dfdl:calendarTimeZone
          ...
          is in IANA (also known as Olson) format <a href="29.-references.md">[IANATimeZone]</a>.</p>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>DFDL implementations MAY support additional values, however, the value
          ...
          Language Identifier as defined by <a href="29.-references.md">[LDML]</a>,
          and <a href="29.-references.md">[CLDR]</a>.</p>
        <p>Annotation: dfdl:element, dfdl:simpleType</p>
      </td>
    </tr>
  </tbody>
...
The pattern is derived from the ICU SimpleDatetimeFormat class described here: [\[ICUDateTime\]](29.-references.md), which uses symbols defined by [\[LDML\]](29.-references.md).

An extension is the formatting symbol I which means accept a subset of ISO 8601 [\[ISO8601\]](29.-references.md) compliant calendars  
...
When numeric fields abut one another directly, with no intervening delimiter characters, they constitute a run of abutting numeric fields. Such runs are parsed specially as described at [\[ICUDateTime\]](29.-references.md).
...
When unparsing, if a time zone symbol is not available for a particular time zone, a fallback may be used as defined in [\[ICUDateTime\]](29.-references.md).
...
[\[1\]](applewebdata://8807EAC1-310D-4BA5-AD7F-B2CE381D7557#_ftnref1) Reference for this CA Realia 0x20 overpunch for negative sign is the article: "EBCDIC to ASCII Conversion of Signed Fields" [\[CARealia\]](29.-references.md) where it says:
